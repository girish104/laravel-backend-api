                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="video_id" id="video_id" class="form-control" placeholder="Enter Youtube Video Id"  data-parsley-trigger="keyup" data-parsley-required-message="Please enter video id" >
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="select" id="show_on" name="show_on">
                                                ...
                                                <option value="2">Both Category And Type</option>
                                            </select>
