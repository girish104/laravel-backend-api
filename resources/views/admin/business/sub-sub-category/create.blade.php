                                ...
                                <div class="row">
                                    <div class="col-md-9 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" id="title" value="{{ old('title') }}" class="form-control" placeholder="Enter title"  data-parsley-trigger="keyup" data-parsley-required-message="Please enter title">
                                    ...
                                    <div class="col-md-4 ">
                                        <div class="form-group">
                                            ...
                                            <select class="select business_type"  name="business_type">
                                                ...
                                                @endphp
                                                <option value="{{ $type->id }}" {{ old('business_type') == $type->id ? 'selected' : '' }}>{{ $type->title }}</option>
                                                @endforeach
                                            </select>
