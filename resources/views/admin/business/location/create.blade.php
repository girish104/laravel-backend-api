                    ...
                    <div class="card">
                        <div class="card-header d-flex p-0">
                            <h3 class="card-title p-3 titleClass">
                                <i class="fa fa-newspaper-o" aria-hidden="true"></i> Location Create
                            </h3>
                        </div>
                        <form role="form" action="{{ route('admin.location.store') }}" method="post" enctype="multipart/form-data" id="form">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                <div class="col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="name" class="form-control" placeholder="Enter name" data-parsley-trigger="keyup" data-parsley-required-message="Please enter name" value="{{ old('name') }}">
                                    ...
                                    <div class="col-md-3 ">
                                        <div class="form-group">
                                            ...
                                            <select class="select" id="is_default" name="is_default">
                                                <option value="1" @if (old('is_default') == 1) selected @endif>Yes</option>
                                                <option value="0" @if (old('is_default') == 0) selected @endif>No</option>
                                            </select>
