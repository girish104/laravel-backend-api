                                    ...
                                    <div class="col-md-5 ">
                                        <div class="form-group">
                                            ...
                                            <select class="select"  name="business_type">
                                                ...
                                                <option value="{{ $type->id }}" {{ old('business_type') == 1 ? 'selected' : '' }} >{{ $type->title }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select class="select" id="status" name="show_on_home_page">
                                                <option value="1" @if (old('show_on_home_page') == 1) selected @endif>Active</option>
                                                <option value="0" @if (old('show_on_home_page') == 0) selected @endif>Inactive</option>
                                            </select>
