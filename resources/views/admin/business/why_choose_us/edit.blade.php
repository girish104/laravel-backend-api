            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <form role="form" action="{{ route('admin.' . $route . '.update', $why_choose_us->id) }}" method="post" enctype="multipart/form-data" id="form">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-9 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" id="title" class="form-control" placeholder="Enter product title"  data-parsley-trigger="keyup" data-parsley-required-message="Please enter product title" value="{{ $why_choose_us->title }}">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="select" id="status" name="status">
                                                <option value="1" @if ($why_choose_us->status == 1) selected @endif>Active</option>
                                                <option value="0" @if ($why_choose_us->status == 0) selected @endif>Inactive</option>
                                            </select>
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" id="thumb_image" name="image" value="{{ $why_choose_us->image_original }}">
                                            <div class="dropzone thumb_image dropzone-file-area" style="min-height: 150px;">
                                                ...
                                                <img src="{{ $why_choose_us->image }}" height="100" width="100px">
                                            </div>
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <textarea height="200px" id="description" name="description" data-parsley-trigger="keyup" data-parsley-required-message="Please enter description" class="form-control">{{ $why_choose_us->description }}</textarea>
