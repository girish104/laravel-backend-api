            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <form role="form" action="{{ route('admin.' . $route . '.update', $festival->id) }}" method="post" enctype="multipart/form-data" id="form">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-9 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" id="title" class="form-control" placeholder="Enter festival title"  data-parsley-trigger="keyup" data-parsley-required-message="Please enter title" value="{{ $festival->title }}">
                                    ...
                                    <div class="col-md-1 ">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" name="position" id="position" class="form-control" placeholder="Enter festival position"  data-parsley-trigger="keyup" data-parsley-required-message="Please enter position" value="{{ $festival->position }}">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select class="select" id="status" name="status">
                                                <option value="1" @if ($festival->status == 1) selected @endif>Active</option>
                                                <option value="0" @if ($festival->status == 0) selected @endif>Inactive</option>
                                            </select>
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" id="thumb_image" name="image" value="{{ $festival->image_original }}">
                                            <div class="dropzone thumb_image dropzone-file-area" style="min-height: 150px;">
                                                ...
                                                <img src="{{ $festival->image }}" height="100" width="100px">
                                            </div>
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <textarea height="200px" id="description" name="description" data-parsley-trigger="keyup" data-parsley-required-message="Please enter description" class="form-control">{{ $festival->description }}</textarea>
