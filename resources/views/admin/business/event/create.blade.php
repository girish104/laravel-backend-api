                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <textarea min-height="200px" id="summary" name="summary" data-parsley-trigger="keyup" data-parsley-required-message="Please enter event overview" class="form-control summary"></textarea>
                                    ...
                                    <div class="col-md-2 ">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="price" id="price" min="0" max="100000000" value="" class="form-control" placeholder="Enter event price" required data-parsley-trigger="keyup" data-parsley-required-message="Please enter event price">
                                    ...
                                    <div class="col-md-2 ">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="old_price" id="old_price" min="0" max="100000000" value="" class="form-control" placeholder="Enter event original price" data-parsley-trigger="keyup" data-parsley-required-message="Please enter event original price">
                                    ...
                                    <div class="col-md-8 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tags" id="tags" class="form-control" placeholder="Enter event tags" value="" data-parsley-trigger="keyup" data-parsley-required-message="Please enter event tags">
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <textarea min-height="200px" id="description" name="description" class="form-control description"></textarea>
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <textarea min-height="200px" id="cancellation_policy" name="cancellation_policy" class="form-control cancellation_policy"></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="meta_keywords" id="meta_keywords" value="" class="form-control" placeholder="Enter meta keywords">
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="meta_descriptions" id="meta_descriptions" value="" class="form-control" placeholder="Enter meta description">
