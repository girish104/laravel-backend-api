            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <form role="form" action="{{ route('admin.' . $route . '.update', $testimonial->id) }}" method="post" enctype="multipart/form-data" id="form">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                            <div class="row">
                                    <div class="col-md-4 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="name" class="form-control" placeholder="Enter name" value="{{ $testimonial->name }}" data-parsley-trigger="keyup" data-parsley-required-message="Please enter name">
                                    ...
                                    <div class="col-md-4 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="designation" id="designation" class="form-control" placeholder="Enter Designation. (Like: CEO of xyz.)" value="{{ $testimonial->designation }}" data-parsley-trigger="keyup" data-parsley-required-message="Please enter designation">
                                    ...
                                    <div class="col-md-1 ">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" name="position" id="position" class="form-control" placeholder="Enter festival position"  data-parsley-trigger="keyup" data-parsley-required-message="Please enter position" value="{{ $testimonial->position }}">
                                    ...
                                    <div class="col-md-1 ">
                                        <div class="form-group">
                                            ...
                                            <select class="select" id="rating" name="rating">
                                                ...
                                                <option value="{{ $rating }}" {{  $testimonial->rating == $rating ? 'selected' : '' }}>{{ $rating }}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="col-md-12 ">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="thumb_image" name="image" value="{{ $testimonial->image_original }}">
                                        <div class="dropzone thumb_image dropzone-file-area" style="min-height: 150px;">
                                            ...
                                            <img src="{{ $testimonial->image }}" height="100" width="100px">
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" id="title" class="form-control" placeholder="Enter title" value="{{ $testimonial->title }}" data-parsley-trigger="keyup" data-parsley-required-message="Please enter title">
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <textarea height="200px" id="description" name="description" data-parsley-trigger="keyup" data-parsley-required-message="Please enter description" class="form-control">{{ $testimonial->description }}</textarea>
