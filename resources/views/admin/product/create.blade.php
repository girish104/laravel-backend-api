                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 hiddenCategories subSubCategory_1">
                                        <div class="form-group">
                                            ...
                                            <select class="select sub_sub_category_1_id"  name="sub_sub_category_1_id"></select>
                                    ...
                                    <div class="col-md-3 ">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" name="min_order_qty" id="min_order_qty" class="form-control" value="1" placeholder="Enter product min order qty" data-parsley-trigger="keyup" data-parsley-required-message="Please enter product min_order_qty">
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <textarea min-height="200px" id="terms_and_conditions" name="terms_and_conditions" class="form-control terms_and_conditions"> {!! old('terms_and_conditions') !!}</textarea>
