                                ...
                                <div class="row">
                                    <div class="col-md-9 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" value="{{ $product->id }}" id="title" class="form-control" placeholder="Enter product title" required data-parsley-trigger="keyup" data-parsley-required-message="Please enter product title">
                                    ...
                                    @foreach(range(1, 6) as $subCategoryType)
                                        @php 
                                            $categoryList = $subSubCategoriesGroupedByType[$subCategoryType] ?? [];
                                        @endphp
                                        <div class="col-md-4 hiddenCategories subSubCategory_{{ $subCategoryType }}">
                                            <div class="form-group">
                                                ...
                                                <select class="select sub_sub_category_{{ $subCategoryType }}_id"  name="sub_sub_category_{{ $subCategoryType }}_id">
                                                    <option value="">Select Sub Sub Category {{ $subCategoryType }} </option>
                                                    @foreach($categoryList as $category)
                                                        <option value="{{ $category->id }}" {{ @$product['sub_sub_category_'.$subCategoryType.'_id'] === $category->id ? 'selected' : '' }}>{{ $category->title }}</option>
                                                    @endforeach
                                                </select>
...
function updateSubSubCategory_2_DropDown(){
    ...
    let html = `<option value=""> Select Sub Sub 2 Category </option>`;
    categoryList.forEach(element => {
...
function updateSubSubCategory_3_DropDown(){
    ...
    let html = `<option value=""> Select Sub Sub 3 Category </option>`;
    categoryList.forEach(element => {
        if (sub_sub_category_1_id == element.sub_sub_category_1_id)
...
function updateSubSubCategory_4_DropDown(){
    ...
    let html = `<option value=""> Select Sub Sub 4 Category </option>`;
    categoryList.forEach(element => {
        if (sub_sub_category_1_id == element.sub_sub_category_1_id)
            if (sub_sub_category_2_id == element.sub_sub_category_2_id)
...
function updateSubSubCategory_5_DropDown(){
    ...
    let html = `<option value=""> Select Sub Sub 5 Category </option>`;
    categoryList.forEach(element => {
        if (sub_sub_category_1_id == element.sub_sub_category_1_id)
            if (sub_sub_category_2_id == element.sub_sub_category_2_id)
                if (sub_sub_category_3_id == element.sub_sub_category_3_id)
...
function updateSubSubCategory_6_DropDown(){
    ...
    let html = `<option value=""> Select Sub Sub 6 Category </option>`;
    categoryList.forEach(element => {
        if (sub_sub_category_1_id == element.sub_sub_category_1_id)
            if (sub_sub_category_2_id == element.sub_sub_category_2_id)
                if (sub_sub_category_3_id == element.sub_sub_category_3_id)
...
<script>
    ...
    $('.sub_sub_category_{{ $cat }}_id').click(function(){
        updateSubSubCategory_{{ $cat }}_DropDown()
    })
    @endforeach
</script>
@endpush
