                    ...
                    <div class="card">
                        <div class="card-header d-flex p-0">
                            <h3 class="card-title p-3 titleClass">
                                <i class="fa fa-newspaper-o" aria-hidden="true"></i> Package Create
                            </h3>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-9 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" value="{{ old('title') }}" id="title" class="form-control" placeholder="Enter package title" required data-parsley-trigger="keyup" data-parsley-required-message="Please enter package title">
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <textarea min-height="200px" id="summary" name="summary" data-parsley-trigger="keyup" data-parsley-required-message="Please enter package overview" class="form-control summary">{{ old('summary') }}</textarea>
                                    ...
                                    <div class="col-md-2 ">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="price" id="price" min="0" max="100000000" value="{{ old('price') }}" class="form-control" placeholder="Enter package price" required data-parsley-trigger="keyup" data-parsley-required-message="Please enter package price">
                                    ...
                                    <div class="col-md-2 ">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="old_price" id="old_price" min="0" max="100000000" value="{{ old('old_price') }}" class="form-control" placeholder="Enter package original price" data-parsley-trigger="keyup" data-parsley-required-message="Please enter package original price">
                                    ...
                                    <div class="col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tags" id="tags" class="form-control" placeholder="Enter , seperated  tags" value="{{ old('tags') }}" data-parsley-trigger="keyup" data-parsley-required-message="Please enter package tags">
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <textarea min-height="200px" id="detail" name="detail" class="form-control detail">{{ old('detail') }}</textarea>
