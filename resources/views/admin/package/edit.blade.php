                    ...
                    <div class="card">
                        <div class="card-header d-flex p-0">
                            <h3 class="card-title p-3 titleClass">
                                <i class="fa fa-newspaper-o" aria-hidden="true"></i> Package Update
                            </h3>
                        </div>
                        <form role="form" action="{{ route('admin.package.update', $package->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-9 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" value="{{ $package->title }}" id="title" class="form-control" placeholder="Enter package title" required data-parsley-trigger="keyup" data-parsley-required-message="Please enter package title">
                                            ...
                                            <select class="select sub_category_id"  name="sub_category_id">
                                                ...
                                                @foreach($business_types->category ?? [] as $category)
                                                    @foreach($category->sub_category as $subCategory)
                                                        ...
                                                        <option value="{{ $subCategory->id }}" {{ $package->sub_category_id == $subCategory->id ? 'selected' : '' }}>{{ $subCategory->title }}</option>
                                                    @endforeach
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <textarea min-height="200px" id="summary" name="summary" data-parsley-trigger="keyup" data-parsley-required-message="Please enter package overview" class="form-control summary">{!! $package->summary !!}</textarea>
                                    ...
                                    <div class="col-md-2 ">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="price" id="price" min="0" max="100000000" value="{{ $package->price }}" class="form-control" placeholder="Enter package price" required data-parsley-trigger="keyup" data-parsley-required-message="Please enter package price">
                                    ...
                                    <div class="col-md-2 ">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" name="price_onwards" id="price_onwards"  value="1" ?? {{ $package->price_onwards ? 'checked' : '' }} class="form-control" placeholder="Is  price onwards"  data-parsley-trigger="keyup">
                                    ...
                                    <div class="col-md-2 ">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="old_price" id="old_price" min="0" max="100000000" value="{{ $package->old_price }}" class="form-control" placeholder="Enter package original price" data-parsley-trigger="keyup" data-parsley-required-message="Please enter package original price">
                                    ...
                                    <div class="col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tags" id="tags" class="form-control" placeholder="Enter package tags" value="{{ $package->tags }}" data-parsley-trigger="keyup" data-parsley-required-message="Please enter package tags">
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <textarea min-height="200px" id="description" name="description" class="form-control description">{!! $package->description !!}</textarea>
                                            <span class="redstart">{{ $errors->first('description') }}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            <label for="exampleDescriptions">Package Detail</label>
                                            <textarea min-height="200px" id="detail" name="detail" class="form-control detail">{!! $package->detail !!}</textarea>
                                            <span class="redstart">{{ $errors->first('detail') }}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            <label for="exampleDescriptions">Cancellation Policy</label>
                                            <textarea min-height="200px" id="cancellation_policy" name="cancellation_policy" class="form-control cancellation_policy"> {!! $package->cancellation_policy !!}</textarea>
                                    ...
                                    <div class="col-md-4 ">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" id="thumb_image" name="image" value="{{ $package->image_original }}">
                                            <div class="dropzone thumb_image dropzone-file-area" style="min-height: 150px;">
                                                ...
                                                <img src="{{ $package->image }}" height="100" width="100px">
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="slug" id="slug" value="{{ $package->slug }}" class="form-control" placeholder="Enter SEO url">
                                    ...
                                    <div class="col-md-5 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="meta_title" id="meta_title" value="{{ $package->meta_title }}" class="form-control" placeholder="Enter meta title">
                                    ...
                                    <div class="col-md-7 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="meta_keywords" id="meta_keywords" value="{{ $package->meta_keywords }}" class="form-control" placeholder="Enter meta keywords">
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="meta_descriptions" id="meta_descriptions" value="{{ $package->meta_descriptions }}" class="form-control" placeholder="Enter meta description">
...
<script>
    var thumb_image = new Dropzone(".thumb_image", {
        url: "{{ route('storage.upload', ['package']) }}",
...
<script>
    ...
    ClassicEditor.create(document.querySelector('#detail')).then(editor => {
        // editor.ui.view.editable.element.style.minHeight = '100px';
    }).catch(console.error);
