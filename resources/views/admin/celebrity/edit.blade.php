                    ...
                    <div class="card">
                        <div class="card-header d-flex p-0">
                            <h3 class="card-title p-3 titleClass">
                                <i class="fa fa-newspaper-o" aria-hidden="true"></i> Celebrity Update
                            </h3>
                        </div>
                        <form role="form" action="{{ route('admin.celebrity.update', $celebrity->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-9 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" value="{{ $celebrity->name }}" id="name" class="form-control" placeholder="Enter celebrity name" required data-parsley-trigger="keyup" data-parsley-required-message="Please enter celebrity name">
                                    ...
                                    <div class="col-md-1 ">
                                        <div class="form-group">
                                            ...
                                            <select class="select" id="is_popular" name="is_popular">
                                                <option value="1" {{ $celebrity->is_popular == 1 ? 'selected' : '' }}>Yes</option>
                                                <option value="0" {{ $celebrity->is_popular == 0 ? 'selected' : '' }}>No</option>
                                            </select>
                                    ...
                                    <div class="col-md-2 ">
                                        <div class="form-group">
                                            ...
                                            <select class="select" id="status" name="status">
                                                <option value="1" {{ $celebrity->status == 1 ? 'selected' : '' }}>Active</option>
                                                <option value="0" {{ $celebrity->status == 0 ? 'selected' : '' }}>Inactive</option>
                                            </select>
                                            ...
                                            <select class="select category_id"  name="category_id">
                                                <option value="">Select Category</option>
                                                    @foreach($business_types->category ?? [] as $category)
                                                        ...
                                                        <option value="{{ $category->id }}" {{ $celebrity->category_id == $category->id ? 'selected' : '' }}>{{ $category->title }}</option>
                                                    @endforeach
                                            </select>
                                            ...
                                            <select class="select sub_category_id"  name="sub_category_id">
                                                ...
                                                @foreach($business_types->category ?? [] as $category)
                                                    @foreach($category->sub_category as $subCategory)
                                                        ...
                                                        <option value="{{ $subCategory->id }}" {{ $celebrity->sub_category_id == $subCategory->id ? 'selected' : '' }}>{{ $subCategory->title }}</option>
                                                    @endforeach
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <textarea min-height="200px" id="summary" name="summary" data-parsley-trigger="keyup" data-parsley-required-message="Please enter celebrity overview" class="form-control summary">{!! $celebrity->summary !!}</textarea>
                                    ...
                                    <div class="col-md-2 ">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="price" id="price" min="0" max="100000000" value="{{ $celebrity->price }}" class="form-control" placeholder="Enter celebrity price" required data-parsley-trigger="keyup" data-parsley-required-message="Please enter celebrity price">
                                    ...
                                    <div class="col-md-2 ">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" name="price_onwards" id="price_onwards"  value="1" ?? {{ $celebrity->price_onwards ? 'checked' : '' }} class="form-control" placeholder="Is  price onwards"  data-parsley-trigger="keyup">
                                    ...
                                    <!-- <div class="col-md-2 ">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="old_price" id="old_price" min="0" max="100000000" value="{{ $celebrity->old_price }}" class="form-control" placeholder="Enter celebrity original price" data-parsley-trigger="keyup" data-parsley-required-message="Please enter celebrity original price">
                                    ...
                                    <div class="col-md-8 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tags" id="tags" class="form-control" placeholder="Enter celebrity tags" value="{{ $celebrity->tags }}" data-parsley-trigger="keyup" data-parsley-required-message="Please enter celebrity tags">
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <textarea min-height="200px" id="description" name="description" class="form-control description">{!! $celebrity->description !!}</textarea>
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <textarea min-height="200px" id="celebrity_detail" name="celebrity_detail" class="form-control celebrity_detail">{!! $celebrity->celebrity_detail !!}</textarea>
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" id="thumb_image" name="image" value="{{ $celebrity->image_original }}">
                                            <div class="dropzone thumb_image dropzone-file-area" style="min-height: 150px;">
                                                ...
                                                <img src="{{ $celebrity->image }}" height="100" width="100px">
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="slug" id="slug" value="{{ $celebrity->slug }}" class="form-control" placeholder="Enter SEO url">
                                    ...
                                    <div class="col-md-5 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="meta_title" id="meta_title" value="{{ $celebrity->meta_title }}" class="form-control" placeholder="Enter meta title">
                                    ...
                                    <div class="col-md-7 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="meta_keywords" id="meta_keywords" value="{{ $celebrity->meta_keywords }}" class="form-control" placeholder="Enter meta keywords">
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="meta_descriptions" id="meta_descriptions" value="{{ $celebrity->meta_descriptions }}" class="form-control" placeholder="Enter meta description">
